 ...
 * Tipの追加を通知する
 */
export const onTipCreated = functions.region('asia-northeast1')
    .firestore
    .document('/tips/{id}')
 ...
 * Tipの更新を通知する
 */
export const onTipUpdated = functions.region('asia-northeast1')
    .firestore
    .document('/tips/{id}')
 ...
 * Tipの削除を通知する
 */
export const onTipRemoved = functions.region('asia-northeast1')
    .firestore
    .document('/tips/{id}')
 ...
 * Flightの追加を通知する
 */
export const onFlightCreated = functions.region('asia-northeast1')
    .firestore
    .document('/flights/{id}')
    .onCreate((snapshot, context) => {
 ...
 * Flightの更新を通知する
 */
export const onFlightUpdated = functions.region('asia-northeast1')
    .firestore
    .document('/flights/{id}')
    .onUpdate((change, context) => {
 ...
 * Flightの削除を通知する
 */
export const onFlightRemoved = functions.region('asia-northeast1')
    .firestore
    .document('/flights/{id}')
    .onDelete((snapshot, context) => {
 ...
 * Contactの追加を通知する
 */
export const onContactCreated = functions.region('asia-northeast1')
    .firestore
 ...
 * Eventの追加を通知する
 */
export const onEventCreated = functions.region('asia-northeast1')
    .firestore
    .document('/events/{id}')
    .onCreate((snapshot, context) => {
 ...
 * Eventの追加を通知する
 */
export const onPhotoCreated = functions.region('asia-northeast1')
    .firestore
    .document('/photos/{id}')
    .onCreate((snapshot, context) => {
